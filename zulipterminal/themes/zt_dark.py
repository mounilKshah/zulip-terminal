...
STYLES = {
    ...
    # 'heading_tag3'    : (Color.DARK_CYAN,           Color.BLACK),
    # 'heading_tag2'    : (Color.WHITE__BOLD,        Color.BLACK),
    # 'heading_tag4'    : (Color.DARK_CYAN,           Color.BLACK),
    # 'heading_tag5'    : (Color.DARK_CYAN,           Color.BLACK),
    # 'heading_tag6'    : (Color.DARK_CYAN,           Color.BLACK),
